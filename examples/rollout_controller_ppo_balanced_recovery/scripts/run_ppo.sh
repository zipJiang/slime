...
storage_root=${PPO_STORAGE_ROOT:-/weka/projects/bvandur1/zjiang31/deontic-ppo-balanced-9b/runs}
...
export RAY_ADDRESS=${RAY_ADDRESS:-172.16.204.2:6425}
...
exec bash "$experiment_root/scripts/sif.sh" python "$experiment_root/scripts/with_torch_cudnn.py" \
  ...
  --num-rollout 130 --num-critic-only-steps 10 --rollout-batch-size 6 --n-samples-per-prompt 1 \
