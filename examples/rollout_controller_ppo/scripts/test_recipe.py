...
class RecipeTests(unittest.TestCase):
    def test_warmup_boundary_is_explicit(self):
        self.assertEqual(estimator_for_round(5, 6), 'refined_td')
        self.assertEqual(estimator_for_round(6, 6), 'direct_branch_td')
    ...
    def test_cannot_resume_original_ppo_into_new_recipe(self):
        with TemporaryDirectory() as temp:
            ...
            self.assertEqual(role_arguments(args)[2]['actor_updates'], 12)
