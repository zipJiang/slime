...
slime_snapshot="$experiment_root/snapshots/slime"
...
slime_env=(--env "VIRTUAL_ENV=$slime_root/.venv"
  ...
  --env "PYTHONPATH=$experiment_root/scripts:$slime_snapshot:/root/Megatron-LM"
...
for slime_key in PYTORCH_CUDA_ALLOC_CONF CUDA_VISIBLE_DEVICES CUDA_DEVICE_MAX_CONNECTIONS OMP_NUM_THREADS \
