"""LocBench's shared warmup/PPO checkpoint and environment contract."""
import hashlib
import json
...
HARNESS = EXPERIMENT / 'snapshots/harness-v1'
...
def contract():
    return dict(profile='locbench-focused-coding-v1', model=MODEL,
